$(async function() {
  // cache some selectors we'll be using quite a bit and added new ones
  ...
  // live code review for updating user

  // $editUser.on('submit', async function(evt) {
  //   evt.preventDefault(); // no page refresh
  //   const token = localStorage.getItem('token');
  //   // grab the required fields
  //   const name = $('#edit-account-name').val();
  //   const editUser = await User.update(name, token);
  //   console.log(name);
  // });
  ...
  $submitForm.on('submit', async function(e) {
    ...
    // create markup for the new story
    const $li = $(`
  ...
  /*
    When page loads, checks local storage to see if the user is already logged in.
    then loads page information accordingly.
   */
  ...
  async function checkIfLoggedIn() {
    ...
    // if there is a token in localStorage, call User.getLoggedInUser to get an instance of User with the right details
  ...
  // This function builds a profile for user
  ...
  function generateStoryHTML(story, isOwnStory) {
    ...
    // create trash from fonrawsome to delete story
